# -*- coding: utf-8 -*-
"""UNet_Lightning_Prediction.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1lTuYPXtAPwKCoYOH-gLVgtGtQi2H7337
"""
...
if __name__ == "__main__":
    ...
    atm_params = ["KI", "CAPE2D", "LPI", "PREC_RATE", "FLUX_PROD", "WMAX_LAYER"]
    resolution = "4by4"

    # data and output paths
    main_path = "/Users/karinpitlik/Desktop/DataScience/Thesis"
    main_folder = f"{main_path}/{case_name}/Ens/Raw"
    entln_folder = f"{main_path}/{case_name}/ENTLN/"
    tensor_save_path = f"{main_path}/{case_name}/Ens/Tensors"
    ...
    if tensors_exist:
        ...
        pos_weight = torch.tensor([10000.0]).to(
            device
