...
% cfg.variable_types = {'lpi', 'KI', 'ds', 'prec_rate', 'cape2d','flux_prod','wdiag'};
% cfg.variable_types = {'wdiag'};
...
function var_cfg = prepare_variable_config(cfg, variable_type, current_var)
    ...
    var_cfg.model_out_root = sprintf('%s/local_processed_data/%s/%s/%s/%s/', ...
    var_cfg.main_path, var_cfg.case_name, upper(current_var), var_cfg.grid_label, var_cfg.interval_name);
